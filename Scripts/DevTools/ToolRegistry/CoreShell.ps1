$categoryTools = @{
    ...
    'clink' = @{
        ...
        GitHubRelease = @{
            ...
            IsZip = $true
            ExtractPath = "$InstallPath\Clink"
            AddToPath = "$InstallPath\Clink"
        }
    ...
    'clink-completions' = @{
        ...
        GitHubRelease = @{
            ...
            IsZip = $true
            ExtractPath = "$env:LocalAppData\clink"
        }
        TestCommand = { Test-Path "$env:LocalAppData\clink\clink-completions" }
        PostInstall = {
