$categoryTools = @{
    ...
    'editly' = @{
        ...
        PostInstall = {
            Write-Log "Editly requires Node.js/npm. Checking availability..." -Level INFO
            if (Test-CommandExists 'npm') {
                ...
                Write-Log "npm not found. Install Node.js first." -Level WARN
            }
        }
    }
    'auto-editor' = @{
        ...
        PostInstall = {
            Write-Log "Auto-Editor requires Python/pip. Checking availability..." -Level INFO
            if (Test-CommandExists 'pip') {
                ...
                Write-Log "pip not found. Install Python first." -Level WARN
            }
        }
    }
    'signet' = @{
